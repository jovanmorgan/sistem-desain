                                    ...
                                    <div class="card">
                                        ...
                                        ?>
                                                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                        ...
                                                        <h4 class="text-center mt-3"><?php echo $user['nama_lengkap']; ?></h4>
                                                        <h5 class="text-center mb-2"><?php echo $user['username']; ?></h5>
                                                    </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                <div class="tab-pane fade show active profile-overview"
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-lg-9 col-md-8"><?php echo $user['password']; ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_user" id="id_user"
                                                            value="<?php echo $user['id_user']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
