...
<div class="page-header">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        ...
        <!-- <?php if ($page_title !== "Dashboard" || $page_title !== "Desain Dan Editan"): ?>
        ...
        <button id="toggleSpinBtn" class="btn btn-success btn-round">Simpan
            Gambar</button>
        <!-- <button id="saveBtn" class="btn btn-success btn-round">Simpan
                    Gambar</button> -->
        <?php endif; ?>
    </div>
    <?php endif; ?>
